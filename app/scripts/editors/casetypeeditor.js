...
class CaseTypeEditor {
    ...
    generateTypeSelectorHTML() {
        const html = $(`<div style="display:inine;position:absolute;right:9px;top:9px"><label>Type: <select class="selectCaseFileModel">${this.typeEditor.getOptionTypeHTML()}</select></div>`);
