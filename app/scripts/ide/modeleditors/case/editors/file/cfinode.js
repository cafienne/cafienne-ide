class CFINode {
    ...
    renderDetails() {
        ...
        this.divCFIDetails.html(
            `<div>
                <img class="cfi-icon" style="width:13px" src="/images/svg/casefileitem.svg" title="Drag item on case model ..."/>
        ...
        this.divCFIDetails.find('.add-child-icon').on('click', e => { this.editor.selectCFINode(this); this.editor.clickAddButton(e, false); });
        this.divCFIDetails.find('.add-sibling-icon').on('click', e => { this.editor.selectCFINode(this); this.editor.clickAddButton(e, true); });
        this.divCFIDetails.find('.delete-icon').on('click', e => { this.editor.selectCFINode(this); this.editor.removeNode(); });
