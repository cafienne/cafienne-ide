...
export class StageDecoratorBox extends DecoratorBox {
    /**
...
export class MilestoneDecoratorBox extends DecoratorBox {
    /**
...
export class CasePlanDecoratorBox extends StageDecoratorBox {
    /**
