...
import SentryView, { EntryCriterionView, ExitCriterionView, ReactivateCriterionView } from "./sentryview";

export default class PlanItemView extends CMMNElementView {
    /**
     * This is a generic export default class for plan item rendering; it takes default properties of the definition
