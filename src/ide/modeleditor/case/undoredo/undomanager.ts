...
export default class UndoManager {
    ...
    updateUndoRedoButtons(undoCount: number = this.getUndoCount(), redoCount: number = this.getRedoCount()): void {
        ...
        if (this.editor.modelView) this.editor.modelView.undoBox.updateButtons(undoCount, redoCount);
    }
    ...
    async undo() {
        if (!this.editor.modelView) return; // Function currently only enabled in CaseModelEditor
