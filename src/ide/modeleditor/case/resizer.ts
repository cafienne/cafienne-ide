...
export default class Resizer {
    ...
    <div class="fence"></div>
        ...
        this.element.modelView.resizeContainer.append(this.html);
    ...
    set visible(visible: boolean) {
        if (visible) {
            this.setPosition();
            this.setSize();
            this.element.modelView.paperContainer.on('scroll', this.scrollListener);
        } else {
            this.element.modelView.paperContainer.off('scroll', this.scrollListener);
        }
    ...
    setPosition() {
        ...
        const leftScroll = this.element.modelView.paperContainer.scrollLeft() || 0;
        const topScroll = this.element.modelView.paperContainer.scrollTop() || 0;
    ...
    handleMouseMove(e: JQuery.Event, resizeDirection: ResizeDirection) {
        ...
        const coor = this.element.modelView.getCursorCoordinates(e);
    ...
    handleMouseUp(e: JQuery.Event) {
        ...
        this.element.modelView.editor.completeUserAction();
    }
