...
export default class CFIDConverter {
    ...
    constructor(cs: CaseView) {
        this.modelView = cs;
        this.repository = this.modelView.editor.ide.repository;
    ...
    async convert() {
        ...
        const caseName = this.modelView.caseDefinition.file.name;
        ...
        const topWrappers = this.modelView.caseDefinition.caseFile.children.map(child => new CFIWrapper(this, child, undefined));
        ...
        this.modelView.caseDefinition.caseFile.typeRef = topTypeFile.fileName;
        ...
        const newDimensions = this.modelView.caseDefinition.dimensions?.toXMLString();
        const newCase = this.modelView.caseDefinition.toXMLString();
        const dimensionsFile = this.modelView.caseEditor.dimensionsFile;
        const caseFile = this.modelView.caseEditor.caseFile;
