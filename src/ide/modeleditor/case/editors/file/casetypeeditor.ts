...
export default class CaseTypeEditor {
    ...
    constructor(public caseFileEditor: CaseFileEditor, public htmlParent: JQuery<HTMLElement>) {
        ...
        this.typeEditor = new TypeEditor(this, this.divTypeEditor, this.modelCanvas);
    ...
    get typeRef() {
        return this.modelCanvas.caseDefinition.caseFile.typeRef;
    }

    set typeRef(typeRef: string) {
        this.modelCanvas.caseDefinition.caseFile.typeRef = typeRef;
