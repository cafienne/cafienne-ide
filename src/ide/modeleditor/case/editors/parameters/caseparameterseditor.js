...
class InputParametersControl extends ParametersControl {
    ...
    get data() {
        return this.modelView.caseDefinition.input;
    }
...
class OutputParametersControl extends ParametersControl {
    ...
    get data() {
        return this.modelView.caseDefinition.output;
    }
...
export class ParameterRow extends RowRenderer {
     ...
     */
    createElement() {
        return this.control.editor.modelView.caseDefinition.createDefinition(CaseParameterDefinition);
    }
}
