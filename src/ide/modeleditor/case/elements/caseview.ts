...
export default class CaseView {
     ...
     */
    getCursorCoordinates(e: JQuery.Event | JQuery<MouseEvent>): Coordinates {
    ...
    createCasePlan(e: JQuery<PointerEvent>): CasePlanView {
    ...
    __addElement(cmmnElement: CMMNElementView): CMMNElementView {
        if (this.loading) {
            return cmmnElement;
        }
