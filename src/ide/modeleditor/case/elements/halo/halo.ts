...
type HaloItemConstructor<D extends CMMNElementDefinition, C extends CMMNElementView<D>, H extends Halo<D, C> = Halo<D, C>> = { 
    new(halo: H): H; 
    defaultBar(halo: H): HaloBar;
};
...
export default class Halo<D extends CMMNElementDefinition = CMMNElementDefinition, V extends CMMNElementView = CMMNElementView<D>> {
     ...
     */
    addItems(...haloItemConstructors: HaloItemConstructor<any, any, any>[]) {
