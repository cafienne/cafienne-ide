...
export default class Halo<D extends CMMNElementDefinition = CMMNElementDefinition, V extends CMMNElementView = CMMNElementView<D>> {
    ...
    <div class="halobar bottom"></div>
        ...
        this.element.modelView.haloContainer.append(html);
    ...
    get haloLeft() {
        return this.element.shape.x - this.element.modelView.paperContainer.scrollLeft()!;
    }

    get haloTop() {
        return this.element.shape.y - this.element.modelView.paperContainer.scrollTop()!;
    }
