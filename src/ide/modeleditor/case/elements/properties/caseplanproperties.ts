...
export default class CasePlanProperties extends StageProperties<CasePlanView> {
    ...
    addCaseRolesButton() {
        ...
        html.find('.btnCaseRolesEditor').on('click', e => this.view.modelCanvas.teamEditor.show());
        html.find('.btnCaseSchemaEditor').on('click', e => this.view.modelCanvas.startCaseEditor.show());
    ...
    addCaseParameters() {
        ...
        html.find('.btnCaseParameters').on('click', e => this.view.modelCanvas.caseParametersEditor.show());
        this.htmlContainer.append(html);
        return html;
    }
