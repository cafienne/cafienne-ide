...
export default class CaseFileItemView extends CMMNElementView<CaseFileItemDef> {
    ...
    get markup() {
        return `<g>
                    <polyline @selector='body' class="cmmn-shape cmmn-border cmmn-casefile-shape" points=" 15,0 0,0 0,40 25,40 25,10 15,0 15,10 25,10" />
                </g>
                <text @selector='label' class="cmmn-text" text-anchor="middle" x="10" y="55" />`;
    }
