...
export default class TypeEditor {
    ...
    selectPropertyRenderer(propertyRenderer?: PropertyRenderer) {
        ...
        if (propertyRenderer) {
            ...
            if (this.modelCanvas && propertyRenderer.property.isComplexType) {
                ...
                const selectedProperty = references.find(cfi => cfi.caseDefinition === this.modelCanvas?.caseDefinition);
                this.modelCanvas.updateSelectedCaseFileItemDefinition(selectedProperty);
            }
        }
