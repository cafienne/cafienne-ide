...
export default class TypeEditor {
    ...
    renderProperty(property, file, container) {
        ...
        html.find('.inputPropertyName').on('change', e => this.changeProperty('name', e.currentTarget.value, property, file, html));
        html.find('.selectType').on('change', e => this.changeProperty('cmmnType', e.currentTarget.value, property, file, html));
