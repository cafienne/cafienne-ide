...
export default class CaseTeamRenderer {
    ...
    constructor(public editor: CaseTeamEditor, public parent: CaseTeamRenderer | undefined, public localCaseTeam: LocalCaseTeamDefinition , public definition: CaseTeamRoleDefinition | undefined, public htmlContainer: JQuery<HTMLElement>) {
    ...
    createCaseRoleRenderer(caseRole: CaseTeamRoleDefinition): CaseRoleRenderer {
...
export class CaseRoleRenderer extends CaseTeamRenderer {
    ...
    constructor(public parent: CaseTeamRenderer, public htmlParent: JQuery<HTMLElement>, localCaseTeam: LocalCaseTeamDefinition, public caseRole: CaseTeamRoleDefinition) {
