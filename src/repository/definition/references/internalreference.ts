...
export default class InternalReference<E extends ElementDefinition<ModelDefinition>> extends Reference<E> {
    private target?: E;
    constructor(protected element: ElementDefinition<ModelDefinition>, protected ref: string) {
        super(element, ref);
    }
    ...
    protected loadDefinition() {
        this.target = <E> this.element.modelDefinition.getElement(this.ref);
    }

    update(newReference?: string | E) {
